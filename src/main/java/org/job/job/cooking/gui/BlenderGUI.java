...
public class BlenderGUI {
    ...
    public void open() {
        Inventory inv = Bukkit.createInventory(null, 36, "§8믹서기: 재료를 혼합해보자");
        ...
        CookingManager.getInstance().getGuiClickListener().updateCookButton(player, inv, StationType.BLENDER);
    }
